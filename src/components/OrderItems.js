...
export default class Orderitems extends React.Component {
  ...
  async fetchItemsFromDB(restId) {
    ...
    await firebase
      .database()
      .ref(`restaurants/${restId}/categories`)
      .on('value', categories => {
        firebase
          .database()
          .ref(`restaurants/${restId}/foodItems`)
          .on('value', foodItems => {
            firebase
              .database()
              .ref('users/' + firebase.auth().currentUser.uid + '/cartScreen')
              .on('value', cartScreen => {
                categoryList = [];
                items = {};
                if (
                  ...
                  Object.entries(categories.val()).map(
                  ...
                  if (
                    ...
                    Object.entries(foodItems.val()).map(
                      ([foodItemId, foodItem]) => {
                        ...
                        if(
                          ...
                          && cartScreen.val()!==null
                          && cartScreen.val().cart
                          && cartScreen.val().cart!==null
                          && cartScreen.val().cart[foodItemId]
                          && cartScreen.val().cart[foodItemId]!==null) {
                            foodObject['quantity'] = cartScreen.val().cart[foodItemId].quantity}
                          else{
                ...
                if (
                  cartScreen.val() &&
                  cartScreen.val().restId ==
                    this.props.navigation.state.params.restId
                )
                  this.setState({
                    cart: cartScreen.val().cart,
                    totalPrice: cartScreen.val().totalPrice,
                    totalItems: cartScreen.val().totalItems,
      ...
      return (
        <Layout
          ...
          <TouchableOpacity
            ...
            <Image
              source={require('../resources/icons/plus-nobg.png')}
          ...
          <TouchableOpacity
            ...
            onPress={() => {
              ...
              cart[key] = items[this.state.currentCategorySelected][key];
              if (
                items[this.state.currentCategorySelected][key].quantity == 0
              ) {
                delete cart[key];
                this.setState({
                  items: items,
            ...
            <Image
              source={require('../resources/icons/minus-nobg.png')}
                  ...
                  style={{
                    ...
                    backgroundColor:
                      item.type == 0
                        ...
                        ? '#795548'
                        : '#d32f2f',
                    borderTopLeftRadius: this.screenHeight * 0.02,
                    borderBottomLeftRadius: this.screenHeight * 0.02,
                  }}>
                  <Text></Text>
                </View>
                <View
                  ...
                  <View>
                    <Text
                      style={{fontWeight: 'bold', fontSize: 19, width: '60%'}}>
                      {item.title}
                    </Text>
                    <Text
                      style={{fontSize: 16, color: '#757575', marginTop: '1%'}}>
                      {item.description}
                    </Text>
                  </View>
                  <View
                    ...
                    <Image
                      source={require('../resources/icons/rupee.png')}
  ...
  cartTabPress() {
    ...
    this.props.navigation.navigate('ViewCart', {
      ordermode: this.props.navigation.getParam('ordermode'),
    });
  }
      ...
      return (
        <TouchableOpacity
          style={{
            ...
            flexDirection: 'row',
            borderRightColor: '#A6E7F9',
            borderRightWidth: 15,
            borderTopColor: '#A6E7F9',
            borderTopWidth: 7,
          }}
          ...
          <Layout
            ...
            <Text style={{color: '#fff'}}>
              Rs {this.state.totalPrice} + taxes
            </Text>
          </Layout>
      ...
      <View>
        <Viewport.Tracker>
          <ScrollView style={styles.container}>
            <ViewportAwareView
              ...
              <View
                style={{
                  flex: 1,
                  alignItems: 'center',
                  height: this.screenHeight * 0.58,
                }}>
                <Image
                  source={require('../resources/Images/food1.jpeg')}
                  style={{
                    width: '100%',
                    height: this.screenHeight * 0.45,
                    marginBottom: '3%',
                  }}
                />
                ...
                <BoxShadow
                  ...
                  <View
                    ...
                    <View
                      ...
                      <Text
                        ...
                        style={{
                          ...
                          width: '90%',
                          color: '#fff',
                          top: this.screenHeight * 0.03,
                          left: this.screenWidth * 0.06,
                        }}>
                        Domino's Pizza
                      </Text>
                      <View
                    ...
                    <View
                      style={{
                        flexDirection: 'row',
                        top: this.screenHeight * 0.04,
                        left: this.screenWidth * 0.08,
                      }}>
                      {this.handlePills('Fast Food, Pizza')}
                    </View>
                    <Text
                      style={{
                        color: '#272727',
                        top: this.screenHeight * 0.07,
                        left: this.screenWidth * 0.08,
                        fontWeight: 'bold',
                      }}>
            ...
            <View
              ...
              <ScrollView
                ...
                {this.state.categoryList.map(category => {
                  if (
                    this.state.currentCategorySelected == category.categoryId
                  ) {
                    return (
                      <TouchableOpacity
                        style={{
                        ...
                        <Text
                          style={{
                            fontSize: 16,
                            marginBottom: this.screenHeight * 0.01,
                            color: '#0092cc',
                            fontWeight: 'bold',
                          }}>
                          {category.name}
                        ...
                        <View
                          style={{
                            borderRadius: (this.screenWidth * 0.01) / 2,
                            width: this.screenWidth * 0.1,
                            height: this.screenHeight * 0.007,
                            backgroundColor: '#55c2ff',
                          }}>
                          <Text></Text>
                        </View>
                  ...
                  return (
                    <TouchableOpacity
                      ...
                      onPress={() => {
                        this.setState({
                          currentCategorySelected: category.categoryId,
                        });
                      }}>
            ...
            <Layout style={{paddingLeft: '2%'}}>{this.renderItemList()}</Layout>
